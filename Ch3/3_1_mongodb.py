...
collection.insert_one({'uid':'a102', 'name':'김춘추', 'hp':'010-1234-2222', 'pos':'과장', 'dep':102, 'rdate':datetime.now()})
collection.insert_one({'uid':'a103', 'name':'장보고', 'hp':'010-1234-3333', 'pos':'대리', 'dep':103, 'rdate':datetime.now()})
